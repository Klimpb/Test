...
function AfflictedSpells:GetData()
	...
	self.spells = {
		...
		-- Empower Rune Weapon
		[47568] = "cooldown:300;cdAnchor:spells;class:DEATHKNIGHT;",
		-- Icebound Fortitude
		...
		-- Anti-Magic Shell
		[48707] = "type:buff;duration:5;cooldown:45;anchor:defenses;cdAnchor:cooldowns;class:DEATHKNIGHT;",
		-- Death Grip
		[49576] = "cooldown:35;cdAnchor:spells;class:DEATHKNIGHT;",
		-- Anti-Magic Zone
		[51052] = "duration:10;anchor:defenses;cooldown:120;cdAnchor:cooldowns;class:DEATHKNIGHT;",
		-- Dancing Rune Weapon
		[49028] = "duration:14;anchor:damage;cooldown:90;cdAnchor:cooldowns;class:DEATHKNIGHT;",
		-- Deathchill
		[49796] = "type:buff;duration:30;anchor:damage;cooldown:120;cdAnchor:cooldowns;class:DEATHKNIGHT;",
		-- Hysteria
		...
		-- Rune Tap
		[48982] = "cooldown:30;cdAnchor:spells;class:DEATHKNIGHT;",
		-- Vampiric Blood
		[55233] = "duration:20;anchor:defenses;cooldown:120;cdAnchor:cooldowns;class:DEATHKNIGHT;",
		-- Leap (Ghoul)
		[47482] = "cooldown:20;cdAnchor:spells;class:DEATHKNIGHT;",
		-- Gnaw (Ghoul)
		...
		-- Avenging Wrath
		[31884] = "duration:20;anchor:damage;cooldown:120;cdAnchor:cooldowns;class:PALADIN;",
		-- Hammer of Justice
		[10308] = "cooldown:40;cdAnchor:cooldowns;class:PALADIN;",
		-- Hand of Protection
		...
		-- Divine Sacrifice
		[64205] = "duration:10;anchor:defenses;cooldown:120;cdAnchor:cooldowns;class:PALADIN;",
		
		-- Warrior
		-- Shattering Throw
		[64382] = "cooldown:300;cdAnchor:damage;class:WARRIOR;",
		-- Intervene
		[3411] = "cooldown:30;cdAnchor:defenses;class:WARRIOR;",
		-- Recklessness
		[1719] = "duration:12;anchor:damage;cooldown:300;cdAnchor:cooldowns;class:WARRIOR;",
		-- Charge
		...
		-- Shield Wall
		[871] = "duration:12;anchor:defenses;cooldown:300;cdAnchor:cooldowns;class:WARRIOR;",
		-- Intimidating Shout
		[5246] = "cooldown:120;cdAnchor:spells;class:WARRIOR;",
		-- Retaliation (dumbasses)
		[20230] = "type:buff;duration:12;cooldown:300;class:WARRIOR;",
		-- Disarm
		...
		[33831] = "duration:30;anchor:damage;cooldown:180;cdAnchor:cooldowns;class:DRUID;",
		-- Berserk
		[50334] = "duration:15;anchor:damage;cooldown:180;cdAnchor:cooldowns;class:DRUID;",
		-- Tiger's fury
		[9846] = 50212,
		[50212] = "cooldown:30;cdAnchor:damage;class:DRUID;",
		-- Nature's Grasp
		[17329] = 53312,
		[27009] = 27009,
		[53312] = "duration:45;anchor:buffs;cooldown:60;cdAnchor:cooldowns;class:DRUID;",
		-- Innervate
		[29166] = "duration:20;anchor:buffs;cooldown:360;cdAnchor:cooldowns;class:DRUID;",
		-- Frenzied Regeneration
		[22842] = "duration:10;anchor:defenses;cooldown:180;cdAnchor:cooldowns;class:DRUID;",
		-- Feral Charge - Bear
		...
		-- Priest
		-- Hymn of Hope
		[64901] = "duration:8;anchor:buffs;cooldown:360;cdAnchor:cooldowns;class:PRIEST;",
		-- Dispersion
		...
		-- Demonic Empowerment
		[47193] = "cooldown:60;cdAnchor:cooldowns;class:WARLOCK;",
		-- Fel Domination
		[18708] = "type:buff;duration:15;anchor:spells;cooldown:900;cdAnchor:cooldowns;class:WARLOCK;",
		-- Demonic Circle: Teleport
		[48020] = "cooldown:30;cdAnchor:defenses;class:WARLOCK;",
		-- Devour Magic (Felhunter)
		[27276] = 48011,
		[27277] = 48011,
		[48011] = "cooldown:8;cdAnchor:spells;class:WARLOCK;",
		-- Intercept (Felguard)
		[30198] = 47996,
		[47996] = "cooldown:30;cdAnchor:spells;class:WARLOCK;",
		...
		[10414] = 49230,
		[24454] = 49230,
		[49230] = "cooldown:6;cdAnchor:interrupts;dontSave:true;class:SHAMAN;",
		-- Heroism
		[32182] = 2825,
		-- Bloodlust
		[2825] = "duration:40;anchor:damage;cooldown:300;cdAnchor:cooldowns;class:SHAMAN;",
		-- Tremor Totem
		[8143] = "type:totem;duration:5;anchor:buffs;repeating:true;class:SHAMAN;",
		-- Feral Spirit
		[51533] = "duration:45;anchor:damage;cooldown:180;cdAnchor:cooldowns;class:SHAMAN;",
		-- Shamanistic Rage
		[30823] = "duration:15;anchor:defenses;cooldown:120;cdAnchor:cooldowns;class:SHAMAN;",
		-- Mana Tide Totem
		...
		-- Pin (Crab)
		[53547] = 53548,
		[53548] = "cooldown:40;cdAnchor:spells;class:HUNTER;",
		-- Snatch (Bid of Pray)
		[53542] = 53543,
		[53543] = "cooldown:60;cdAnchor:spells;class:HUNTER;",
		-- Sonic Blast (Bat)
		[53567] = 53568,
		[53568] = "cooldown:60;cdAnchor:interrupts;class:HUNTER;",
		-- Black Arrow
		[63670] = 63672,
		[63671] = 63672,
		[63672] = "cooldown:30;cdAnchor:spells;class:HUNTER;",
		-- Master's Call
		...
		[49056] = 34600,
		-- Snake Trap
		[34600] = "type:trap;duration:60;anchor:spells;cooldown:30;cdAnchor:cooldowns;dontSave:true;class:HUNTER;",
		-- Deterrence
		[19263] = "duration:5;anchor:defenses;cooldown:90;cdAnchor:cooldowns;class:HUNTER;",
		-- Scare Beast
		[14327] = "type:debuff;cooldown:30;anchor:spells;class:HUNTER;",
		-- Viper Sting
		[3034] = "cooldown:15;anchor:spells;class:HUNTER;",
		
		-- Mage
		-- Presence of Mind
		[12043] = "cooldown:120;anchor:cooldowns;class:MAGE;",
		-- Cold Snap
		[11958] = "cooldown:384;anchor:cooldowns;resets:12472,44572,45438,;",
		-- Deep Freeze
		[44572] = "cooldown:30;anchor:spells;class:MAGE;",
		-- Icy Veins
		[12472] = "duration:20;anchor:damage;cooldown:144;cdAnchor:cooldowns;class:MAGE;",
		-- Invisibility
		[66] = "duration:23;anchor:defenses;cooldown:180;cdAnchor:cooldowns;class:MAGE;",
		-- Ice Block
		...
		-- Rogue
		-- Killing Spree
		[51690] = "cooldown:120;cdAnchor:cooldowns;class:ROGUE;",
		-- Shadow Dance
		...
		-- Adrenaline Rush
		[13750] = "duration:15;anchor:damage;cooldown:180;cdAnchor:cooldowns;class:ROGUE;",
		-- Blade Furry
		[13877] = "duration:15;anchor:damage;cooldown:120;cdAnchor:cooldowns;class:ROGUE;",
		-- Cold Blood
		[14177] = "cooldown:180;cdAnchor:cooldowns;class:ROGUE;",
		-- Preparation
		[14185] = "cooldown:300;cdAnchor:cooldowns;resets:14177,36554,26889,11305,26669,;",
		-- Tricks of the Trade
