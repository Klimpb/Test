...
local function set(info, value)
	...
	if( arg2 and arg3 ) then
		PartyCC.db.profile[arg1][arg2][arg3] = value
	elseif( arg2 ) then
...
local function get(info)
	...
	if( arg2 and arg3 ) then
		return PartyCC.db.profile[arg1][arg2][arg3]
	elseif( arg2 ) then
...
local function setMulti(info, value, state)
	...
	if( arg2 and arg3 ) then
		PartyCC.db.profile[arg1][arg2][arg3][value] = state
	elseif( arg2 ) then
...
local function getMulti(info, value)
	...
	if( arg2 and arg3 ) then
		return PartyCC.db.profile[arg1][arg2][arg3][value]
	elseif( arg2 ) then
...
local function loadOptions()
	...
	options.args.spells = {
		...
		args = {
			desc = {
				order = 0,
				type = "description",
				name = L["Lets you choose which spells should be shown if a party member uses them."],
			},
			list = {
				order = 1,
				type = "group",
	...
	-- Load spell list
	local id = 0
	for spellName in pairs(PartyCC.spells) do
		id = id + 1
