...
SSPVPLocals = setmetatable( {
	...
	["(.+) was taken by the"] = "(.+) wurde von der (.+) erobert",
	["(.+) was destroyed by the"] = "(.+) wurde von der (.+) zerst\195\182rt",
	
	["AVNodes"] = {
		["DBNB"] = "Nordbunker von Dun Baldar",
		["DBNS"] = "S/195/188dbunker von Dun Baldar",
		["EFWT"] = "\195\150stlicher Frostwolfturm",
		["WFWT"] = "Westlicher Frostwolfturm",
		["FWGY"] = "Friedhof der Frostw\195\182lfe",
		["FWRH"] = "Heilerhf\195\188tte der Frostw\195\182lfe",
		["IBGY"] = "Eisblutfriedhof",
		["IBT"] = "Eisblutturm",
		["IWB"] = "Eisschwingenbunker",
		["SFGY"] = "Schneewehenfriedhof",
		["SHB"] = "Steinbruchbunker",
		["SHGY"] = "Steinbruchfriedhof",
		["SPAS"] = "Lazarett der Sturmlanzen",
		["SPGY"] = "Friedhof des Sturmlanzen",
		["TP"] = "Turmstellung",
