...
function Config:General()
	local config = {
		...
		{ order = 2, group = L["General"], text = L["Show team summary after rated arena ends"], help = L["Shows team names, points change and the new ratings after the arena ends."], type = "check", var = {"Arena", "score"}},
